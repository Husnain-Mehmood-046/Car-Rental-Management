...
public class LoginSignupForm extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Left blue panel with image and text
        VBox leftPane = new VBox(10);
        leftPane.setAlignment(Pos.CENTER);
        leftPane.setStyle("-fx-background-color: #0078D7;");
        leftPane.setPrefWidth(400);

        // Icon and label for the left pane
        ...
        createAccountButton.setOnAction(e -> {
            ...
            leftPane.getChildren().remove(createAccountButton); // Remove "Create Account" button
            leftPane.getChildren().add(backToLoginButton); // Add "Back to Login" button
        });
        ...
        backToLoginButton.setOnAction(e -> {
            ...
            leftPane.getChildren().remove(backToLoginButton); // Remove "Back to Login" button
            leftPane.getChildren().add(createAccountButton); // Add "Create Account" button
        });
